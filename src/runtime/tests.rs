...
fn structured_trace_uses_real_timestamps() {
    ...
    assert_eq!(structured.events[0].offset_ms, 0, "first event offset must be 0");
    assert_eq!(structured.events[1].offset_ms, 250, "second event offset must use real timestamp");
